...
class StagiaireManagerTest extends TestCase
{
    ...
    {
        $stagiaireManager = new StagiaireManager($this->stagiaireMapperInMemory);
        $stagiaires = $stagiaireManager->listerLesStagiaires();
    ...
    {
        $stagiaireManager = new StagiaireManager($this->stagiaireMapperInMemory);
        $stagiaireManager->creerUnStagiaire('John');
    ...
    {
        $stagiaireManager = new StagiaireManager($this->stagiaireMapperMySQL);
        $stagiaires = $stagiaireManager->listerLesStagiaires();
